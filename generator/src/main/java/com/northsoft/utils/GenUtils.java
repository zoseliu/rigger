...
package com.northsoft.utils;

import com.northsoft.entity.ColumnEntity;
import com.northsoft.entity.TableEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.northsoft" : mainPath;
        ...
        map.put("author", params.get("author"));
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(template, tableEntity.getClassName(), params.get("package"), params.get("moduleName"))));
